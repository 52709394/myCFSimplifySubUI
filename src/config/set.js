...
export function renewConfig(obj) {
    ...
    const newObj = {
        ...
        "all_user": {
            "manual_write": obj.all_user?.manual_write,
            "addr": obj.all_user?.addr,
            "port": obj.all_user?.port,
            "ports": obj.all_user?.ports,
            "isInsecure": obj.all_user?.isInsecure,
    ...
    return `
        {
            ...
            "all_user": {
                "manual_write 说明": "导入'xray','sing-box'配置,写入'users_arr'用户中,使用字串布尔值启用手动模式",
                "manual_write": null,
